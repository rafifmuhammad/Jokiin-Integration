...
if ($user[0]['role'] == 'Penjoki') {
    $assignments = query("SELECT DISTINCT *
                    ...
                    WHERE tb_tugas.kd_penjoki = '$kdUser'
...
<body>
    ...
    <section class="content">
        <div class="container">
            ...
            <p>Riwayat dari tugas yang telah Anda kerjakan.</p>
                        ...
                        <div class="project-item">
                            ...
                            <div class="box-project-item">
                                ...
                                <div class="status-wrapper">
                                    ...
                                    <div class="status <?php echo filter_var($assignment['is_finished'], FILTER_VALIDATE_BOOLEAN) ? 'finish' : ''; ?>">
                                        <?= filter_var($assignment['is_finished'], FILTER_VALIDATE_BOOLEAN) ? 'Status: Selesai' : 'Status: Belum Selesai'; ?>
                                    </div>
                                </div>
                            </div>
                            <div class="box-project-item">
                                <p>Rp. <?= $assignment['total_bayar']; ?></p>
                                <button class="button" onclick="location.href='./detail.php?kd_tugas=<?= $assignment['kd_tugas']; ?>'">Detail</button>
                            </div>
                        </div>
                    <?php endforeach; ?>
                <?php else : ?>
                    <div class="empty">
                        ...
                        <p>Anda tidak memiliki tugas saat ini!</p>
                    </div>
                <?php endif; ?>
            </div>
        </div>
